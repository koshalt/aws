...
echo "export JAVA_OPTS=\"-Xms1024m -Xmx2048m -XX:MaxPermSize=1024m -XX:+CMSClassUnloadingEnabled -XX:+CMSPermGenSweepingEnabled\"" >> ~/.profile
echo "export CATALINA_OPTS=\"-Xms1024m -Xmx2048m -XX:MaxPermSize=1024m -XX:+CMSClassUnloadingEnabled -XX:+CMSPermGenSweepingEnabled\"" >> ~/.profile
source ~/.profile
